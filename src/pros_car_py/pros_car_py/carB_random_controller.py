...
import rclpy
from .car_models import CarBControlSignal, CarBState
...
class CarBRandomController(Node):
        ...
        if self._front_serial.in_waiting:
            ...
            if current_time - self.last_log_time >= self.log_interval:
                try:
                    ...
                    front_state = CarBState(**front_state_data)
                    back_state = CarBState(**back_state_data)
    ...
    def _generate_random_command_str(self):
        ...
        control_signal = CarBControlSignal(target_vel=random_velocity)
