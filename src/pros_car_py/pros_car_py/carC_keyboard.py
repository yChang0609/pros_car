...
class CarCKeyboardController(Node):
    ...
    def handle_key_i(self):
        ...
        self.joint_pos[1] = self.clamp(
            self.joint_pos[1] - self.rotate_angle, math.radians(0), math.radians(180)
        )
    ...
    def handle_key_y(self):
        ...
        self.joint_pos[2] = self.clamp(
            self.joint_pos[2] - self.rotate_angle, math.radians(0), math.radians(150)
        )
    ...
    def handle_key_n(self):
        ...
        self.joint_pos[3] = self.clamp(
            self.joint_pos[3] + self.rotate_angle, math.radians(50), math.radians(180)
        )
    ...
    def handle_key_u(self):
        ...
        self.joint_pos[4] = self.clamp(
            self.joint_pos[4] + self.rotate_angle, math.radians(0), math.radians(70)
        )
